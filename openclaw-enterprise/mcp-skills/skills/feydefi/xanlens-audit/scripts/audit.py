#!/usr/bin/env python3
"""
XanLens GEO Audit — Check brand visibility across AI search engines.
...
API_URL = "https://xanlens.xyz/api/v1/audit"
...
def print_report(result: dict):
    ...
    print(f"\n{'='*50}")
    print(f"  Full report: https://xanlens.xyz")
    print(f"{'='*50}\n")


def main():
    parser = argparse.ArgumentParser(description="XanLens GEO Audit")
