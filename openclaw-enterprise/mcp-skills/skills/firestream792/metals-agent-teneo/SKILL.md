...
description: Provides real time prices for gold, silver, and copper
---
...
|---------|-----------|-------|-------------|
| `gold` | - | Free | Get the current gold price |
| `silver` | - | Free | Get the current silver price |
| `copper` | - | Free | Get the current copper price |
| `table` | - | Free | Get a table of all metal prices |
