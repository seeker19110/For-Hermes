# ClawPhone Invite Flow Specification
...
2. Clawdbot creates invite → returns link: clawphone.dev/c/abc123
3. Alice texts/emails Bob the link (out of band)
4. Bob clicks link → his Clawdbot claims the invite
5. Alice's Clawdbot notifies her: "Bob claimed your connect link. Approve?"
6. Alice: "Yes"
...
```json
{
  ...
  "link": "https://clawphone.dev/c/abc123def456"
}
```
...
**Headers:**
```
X-ClawPhone-Key: ed25519:PUBKEY_HEX
X-ClawPhone-Timestamp: UNIX_TIMESTAMP
X-ClawPhone-Signature: SIGNATURE_HEX
```
...
Headers: X-ClawPhone-Key, X-ClawPhone-Timestamp, X-ClawPhone-Signature
```
...
`~/.clawdbot/clawphone/invites.json`:
```json
{
  "created": [
    {
