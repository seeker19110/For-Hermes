...
const MASTER_NFT_ADDRESS = process.env.MASTER_NFT_ADDRESS || '0xb7f14622ea97b26524BE743Ab6D9FA519Afbe756';
const CHUNK_SIZE = parseInt(process.env.CHUNK_SIZE || '100000'); // 100KB
