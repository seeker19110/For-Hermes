 ...
 *
 * This middleware automatically enriches tool calls with Muninn MCP memory context.
...
export class MuninnMiddleware {
    ...
    /**
     * Intercept a tool call and enrich it with Muninn MCP context
     */
    async interceptToolCall(toolName, args) {
        ...
        try {
            // Search Muninn MCP for relevant context
    ...
    formatContextInjection(injection) {
        ...
        return `${prefix} (auto-loaded from Muninn MCP)
