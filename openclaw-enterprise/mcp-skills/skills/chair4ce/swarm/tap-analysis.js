...
- Rank: Master Sergeant (MSgt), U.S. Air Force
- Retirement Date: April 10, 2027 (~13 months out)
- Years of Service: 20 years
- Location: Tucson, Arizona
- Family: Married with 4 children (elementary, middle, high school)
- Career Interests: Software development, AI, IT management
- Side Business: Oaiken LLC (custom software development)
- Spouse Business: Stork and Stencil Creations (merch/t-shirts)
- Key Priorities: VA benefits, healthcare transition, retirement pay, 
  potential SkillBridge, entrepreneurship support
`;
...
async function main() {
  ...
  console.log(`👤 Analyzing for: MSgt, USAF, retiring Apr 2027`);
